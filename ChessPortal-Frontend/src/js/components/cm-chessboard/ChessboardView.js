...
export class ChessboardView {
    ...
    createSvgAndGroups() {
        ...
        this.defsGroup = Svg.addElement(this.svg, "defs");
    }
    ...
    defineDefs() {
            ...
            const marker = Svg.addElement(this.defsGroup, "marker", {
                "id": "arrowhead", "markerWidth": 5, "markerHeight": 7,
                "refX": 0, "refY": 3.5, "orient": "auto"
            })
            const polygon = Svg.addElement(marker, "polygon", { "points": "0 0, 5 3.5, 0 7" })
    ...
    drawArrow(startPoint, endPoint) {
        ...
        const xoffset = this.squareWidth / 2;
        const yoffset = this.squareHeight / 2;

        Svg.addElement(this.markersGroup, "line", { "x1": startPoint.x + xoffset, "y1": startPoint.y + yoffset, "x2": endPoint.x + xoffset, "y2": endPoint.y + yoffset, "stroke": "#000", "stroke-width": 3, "marker-end": "url(#arrowhead)" })
    ...
    setSquareColor(index, color) {
        ...
        let squareStyle = square.getAttribute("style");
        if (squareStyle) {
            square.removeAttribute("style");
        } else {
            square.setAttribute("style", `fill:${color}`);
        }
    }
