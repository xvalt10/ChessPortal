...
public class GameUtil {
	...
	public static int getPlayerEloBasedOnGameTime(Player player, GameTimeType gameTimeType) {
		int elo = 0;
		switch (gameTimeType) {
		case BULLET:
	...
	public static void setPlayerEloBasedOnGameTime(Player player, GameTimeType gameTymeType, int elo) {
